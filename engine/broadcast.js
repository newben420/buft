...
class BroadcastEngine {
    ...
    static entry = async (ticker, signal, rawPrompt) => {
        ...
        if(Site.ALRT_SHOW_ONLY_SUPPORTED && !((verdict || {obj: {supported: false}}).obj.supported)) {
            return;
        }

        if(Site.ALRT_SHOW_MINIMUM_CONFIDENCE && (verdict || {obj: {confidence: 0}}).confidence < Site.ALRT_SHOW_MINIMUM_CONFIDENCE) {
            return;
        }
